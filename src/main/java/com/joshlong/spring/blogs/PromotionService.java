...
class PromotionService {
    ...
    public void promote(BlogPost blog) {
        this.tx.execute(t -> {
            ...
            return this.ds.update("update spring_blog_posts set promoted = NOW() where url = ? ", blog.url().toString());
        });
    }
    ...
    @SneakyThrows
    private static void addSocialToSocialMediaMap(ResultSet resultSet, Social social, Map<Social, String> socialMediaMap) {
