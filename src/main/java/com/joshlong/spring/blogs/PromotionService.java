...
class PromotionService {
	...
	@SneakyThrows
	private static void safeAdd(ResultSet resultSet, Social social, Map<Social, String> socialMediaMap) {
	...
	public Collection<PromotableBlog> getPromotableBlogs() {
		...
		return this.ds.query(sql, (rs, rowNum) -> {
			...
			Arrays.asList(Social.values()).forEach(s -> safeAdd(rs, s, socialMap));
