...
class PromotionConfiguration {
    ...
    ApplicationRunner promotionApplicationRunner(TaskScheduler taskScheduler) {
        var duration = Duration.of(1, TimeUnit.MINUTES.toChronoUnit());
        var periodicTrigger = new PeriodicTrigger(duration);
        return args -> taskScheduler.schedule(this::doPromotion, periodicTrigger);
    }
