...
class IntegrationConfiguration {
	...
	@Bean
	ApplicationListener<AllPipelinesInitializedEvent> promotionIntegrationFlowRunner(Map<String, Pipeline> pipelines,
			IntegrationFlowContext ctx) {
		return event -> visitPipelinesAndLaunchIntegrationFlow(ctx, pipelines,
				IntegrationConfiguration::buildPromotionIntegrationFlow);
	}
