...
class DefaultJsoupTeamClientTest {
	...
	/*
	 *
	 * @Test void team() { var client = new DefaultJsoupTeamClient(TestUtils.supplier());
	 * var team = client.team(); Assertions.assertTrue(team.stream() .anyMatch(t ->
	 * t.socialMedia().containsKey(Social.TWITTER) &&
	 * t.socialMedia().containsKey(Social.GITHUB) && t.location().contains("aisle seat")
